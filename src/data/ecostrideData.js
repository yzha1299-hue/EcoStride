    ...
    routes: [
      {
        ...
        postcode: '3011',
        modes: ['Walk', 'Cycle'],
        start: { lat: -37.8011, lng: 144.9033 },
        end: { lat: -37.7832, lng: 144.8988 },
      },
      {
        id: 'capital-city-trail',
        name: 'Capital City Trail',
        detail: 'Shared path - ~3.1 km - quiet streets',
        suburb: 'Carlton',
        postcode: '3053',
        modes: ['Walk', 'Cycle'],
        start: { lat: -37.783, lng: 144.9615 },
        end: { lat: -37.783, lng: 144.992 },
      },
      {
        id: 'main-yarra-trail',
        ...
        start: { lat: -37.826, lng: 144.983 },
        end: { lat: -37.8305, lng: 145.0177 },
      },
      {
        id: 'beach-road-bike-path',
        name: 'Beach Road Bike Path',
        detail: 'Coastal path - ~5.2 km - accessible',
        suburb: 'St Kilda',
        postcode: '3182',
        modes: ['Cycle', 'Micro-mobility'],
        start: { lat: -37.866, lng: 144.974 },
        end: { lat: -37.907, lng: 144.986 },
      },
      {
        // A place rather than a trail: it has a start point and no end.
        id: 'southern-cross-bike-hub',
        name: 'Southern Cross Bike Hub',
        detail: 'Secure racks - near station',
        suburb: 'Docklands',
        postcode: '3008',
        modes: ['Cycle', 'Micro-mobility'],
        start: { lat: -37.8181, lng: 144.9525 },
        end: null,
      },
    ],
  },
